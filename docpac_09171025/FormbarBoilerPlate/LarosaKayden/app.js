...
app.get('/sendpogs', isAuthenticated, (req, res) => {
    const data = {
        ...
        amount: 2,
        pin: 3000,
        reason: "testing pogs transfer"
    };
    socket.emit('transferDigipogs', data);
    res.send('Pogs send to auth server');
});
...
socket.on('classUpdate', (classroomData) => {
    ...
    console.log(`Response: ${classroomData.poll.totalResponses} / ${classroomData.poll.totalResponders} students responded.`);
